...
namespace reportForm.loginDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`UID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`U" +
                "sername` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`Username`, `Email`, `Password`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `Username` = ?, `Email` = ?, `Password` = ? WHERE ((`UID` = ?)" +
                " AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Email" +
                "` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` " +
                "= ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::reportForm.Properties.Settings.Default.loginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UID, Username, Email, [Password] FROM Users";
        ...
        public virtual int Delete(int Original_UID, string Original_Username, string Original_Email, string Original_Password) {
        ...
        public virtual int Update(string Username, string Email, string Password, int Original_UID, string Original_Username, string Original_Email, string Original_Password) {
            if ((Username == null)) {
